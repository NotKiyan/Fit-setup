...
export default function HomePage() {
    ...
    const featuredProducts = [
        { id: 1, name: 'Pro-Grade Dumbbell Set', price: '$249.99', image: 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=2070&auto=format&fit=crop' },
        { id: 2, name: 'Adjustable Workout Bench', price: '$189.99', image: 'https://images.unsplash.com/photo-1599058917212-d750089bc07e?q=80&w=2069&auto=format&fit=crop' },
        { id: 3, name: 'CardioMax Treadmill', price: '$899.99', image: 'https://images.unsplash.com/photo-1571902943202-507ec2618e8f?q=80&w=1975&auto=format&fit=crop' },
        { id: 4, name: 'Kettlebell Pro', price: '$79.99', image: kellebell },
    ];

    const categories = [
        { name: 'Strength', image: 'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80' },
        { name: 'Cardio', image: 'https://images.unsplash.com/photo-1723117418780-1b74b25af9bc?q=80' },
        { name: 'Functional', image: 'https://plus.unsplash.com/premium_photo-1664299208816-ef56887db111?q=80' },
    ];
